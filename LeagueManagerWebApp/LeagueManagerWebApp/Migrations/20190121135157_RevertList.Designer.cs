...
namespace LeagueManagerWebApp.Data.Migrations
{
    ...
    [Migration("20190121135157_RevertList")]
    partial class RevertList
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeagueManagerWebApp.Models.MatchupModel", b =>
                {
                    b.HasOne("LeagueManagerWebApp.Models.PlayerModel", "Loser")
                        .WithMany()
                        .HasForeignKey("LoserId");

                    b.HasOne("LeagueManagerWebApp.Models.PlayerModel", "Player1")
                        .WithMany()
                        .HasForeignKey("Player1Id");

                    b.HasOne("LeagueManagerWebApp.Models.PlayerModel", "Player2")
                        .WithMany()
